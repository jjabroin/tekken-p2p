...
export const MOVES = {
  ...
  m12:  { n: '1,2', btn: 2, st: 8, ac: 3, rc: 11, dmg: 11, range: 48, h: 'h', anim: ['cross1', 'cross2', 'cross3'] },
  // --- 앞 방향기 ---
  f1:   { n: 'f+1', btn: 1, dir: 'f', st: 8, ac: 3, rc: 11, dmg: 10, range: 50, h: 'm', push: 3, anim: ['jab1', 'jab2', 'cross2'] },
  ...
  // --- 뒤 방향기 ---
  b1:   { n: 'b+1', btn: 1, dir: 'b', st: 7, ac: 3, rc: 10, dmg: 8, range: 48, h: 'h', anim: ['jab1', 'jab2', 'jab1'] },
  ...
  d1:   { n: 'd+1', btn: 1, crouch: true, st: 8, ac: 3, rc: 10, dmg: 7, range: 46, h: 'm', anim: ['jab1', 'jab2'] },
  ...
  ws1:  { n: 'ws+1', btn: 1, rise: true, st: 9, ac: 3, rc: 11, dmg: 9, range: 48, h: 'm', anim: ['jab1', 'jab2', 'cross2'] },
  ...
  // --- 스크류 (공중 콤보 연장, 콤보당 1회) ---
  screw12: { n: '1+2 스크류', btn: 12, st: 14, ac: 4, rc: 21, dmg: 12, range: 54, h: 'm', screw: true, push: 3, anim: ['cross1', 'cross2', 'up1'] },
  // --- 무릎/특수 ---
